    ...
    <div className="flex justify-center pt-2">
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogTrigger asChild>
          <Button
            className="bg-[#002C5F] hover:bg-[#001A3A] text-white border-0 px-8 py-4 rounded-xl font-bold uppercase tracking-widest text-[10px] transition-all flex items-center justify-center gap-2 group"
            size="lg"
          >
