      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-1/2 w-full flex">
          <div className="rounded-xl shadow-md overflow-hidden bg-white dark:bg-gray-800/80 w-full h-full flex flex-col">
            <table className="w-full border-collapse flex-grow">
              <thead className="bg-[#18b6a5] text-white">
                <tr>
              ...
              <tbody className="flex-grow">
                {tenorData.map((data) => (
                  <tr
                    key={data.tenor}
                    className={`border-b border-gray-100 dark:border-gray-700 transition-all duration-200 hover:bg-gray-50 cursor-pointer ${selectedTenor === data.tenor ? 'bg-gray-100 dark:bg-gray-700/20' : ''
                      }`}
                  ...
                  >
                    ...
                    <td className="py-3.5 text-center">
                      <span className="text-[#18b6a5] font-medium text-sm">
        ...
        <div className="lg:w-1/2 w-full flex">
          <div className="flex flex-col space-y-4 w-full h-full justify-between">
            ...
            <div className="bg-[#18b6a5] rounded-xl p-4 flex justify-between items-center text-white shadow-xl transition-all duration-300 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] cursor-pointer">
            ...
            <div className="bg-gray-100 rounded-xl p-4 flex justify-between items-center shadow-xl transition-all duration-300 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] cursor-pointer">
              <div className="flex items-center">
                <div className="bg-[#18b6a5] rounded-full w-10 h-10 flex items-center justify-center mr-3">
                  <Shield className="h-5 w-5 text-white" />
                </div>
                <div className="text-sm font-medium text-[#18b6a5]">Jenis Asuransi</div>
              </div>
              <div className="text-lg font-bold text-[#18b6a5]">{insuranceTypeDisplay}</div>
            </div>
          </div>
        </div>
      </div>
